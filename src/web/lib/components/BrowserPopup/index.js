...
const BrowserPopup = ({ colors, size = "small", selectSettings, selectedColor }) => {
  ...
  <div className={`browser-popup browser-popup--${size}`}>
    <div className="browser-popup__caret-shadow" style={{
    ...
    <div className="browser-popup__caret" style={{
      background: colors.popup,
    }} />
    <ul className="browser-popup__inner" style={{
      background: colors.popup,
      transition: selectSettings.transition,
      outline:
        selectedColor === "popup"
          ...
          <li key={index} style={{
            ...
            outline:
              selectedColor === "popup_text"
                ...
                : selectSettings.inactive}}
          >
            <div className="browser-popup__item" style={{
